...
# direct methods
.method public constructor <init>(Lj$/time/temporal/TemporalField;Lj$/time/format/TextStyle;Lj$/time/format/B;)V
    .locals 0
...
.method public final h(Lj$/time/format/y;Ljava/lang/StringBuilder;)Z
    ...
    .line 2
    .line 3
    invoke-virtual {p1, v0}, Lj$/time/format/y;->a(Lj$/time/temporal/TemporalField;)Ljava/lang/Long;
    ...
    .line 11
    :cond_0
    sget-object v1, Lj$/time/temporal/k;->b:Lj$/desugar/sun/nio/fs/n;
    ...
    .line 14
    .line 15
    invoke-interface {v2, v1}, Lj$/time/temporal/TemporalAccessor;->O(Lj$/desugar/sun/nio/fs/n;)Ljava/lang/Object;
    ...
    .line 40
    .line 41
    iget-object v4, p0, Lj$/time/format/q;->a:Lj$/time/temporal/TemporalField;

    .line 42
    .line 43
    invoke-virtual/range {v2 .. v8}, Lj$/time/format/B;->b(Lj$/time/chrono/j;Lj$/time/temporal/TemporalField;JLj$/time/format/TextStyle;Ljava/util/Locale;)Ljava/lang/String;
    ...
    .line 59
    .line 60
    invoke-virtual/range {v1 .. v6}, Lj$/time/format/B;->c(Lj$/time/temporal/TemporalField;JLj$/time/format/TextStyle;Ljava/util/Locale;)Ljava/lang/String;
    ...
    .line 78
    .line 79
    invoke-direct {v0, v2, v1, v3, v4}, Lj$/time/format/i;-><init>(Lj$/time/temporal/TemporalField;IILj$/time/format/F;)V
...
.method public final j(Lj$/time/format/v;Ljava/lang/CharSequence;I)I
    ...
    .line 21
    iget-object v2, v2, Lj$/time/format/D;->c:Lj$/time/chrono/j;
    ...
    .line 26
    .line 27
    iget-object v2, v2, Lj$/time/format/DateTimeFormatter;->e:Lj$/time/chrono/j;
    ...
    .line 48
    .line 49
    invoke-virtual {v2, v6, v7, v1, v3}, Lj$/time/format/B;->d(Lj$/time/chrono/j;Lj$/time/temporal/TemporalField;Lj$/time/format/TextStyle;Ljava/util/Locale;)Ljava/util/Iterator;
    ...
    .line 56
    .line 57
    invoke-virtual {v2, v7, v1, v3}, Lj$/time/format/B;->e(Lj$/time/temporal/TemporalField;Lj$/time/format/TextStyle;Ljava/util/Locale;)Ljava/util/Iterator;
    ...
    .line 129
    .line 130
    invoke-interface {v6}, Lj$/time/chrono/j;->v()Ljava/util/List;
    ...
    .line 207
    .line 208
    invoke-direct {v1, v2, v5, v6, v3}, Lj$/time/format/i;-><init>(Lj$/time/temporal/TemporalField;IILj$/time/format/F;)V
    ...
    .line 214
    .line 215
    invoke-virtual {v1, p1, p2, p3}, Lj$/time/format/i;->j(Lj$/time/format/v;Ljava/lang/CharSequence;I)I
