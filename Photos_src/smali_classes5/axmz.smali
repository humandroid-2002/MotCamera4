...
.method public static a(Landroid/content/Context;Landroid/net/Uri;)Landroid/net/Uri;
    ...
    .line 3
    :try_start_0
    invoke-static {p1, p0}, Lbaxx;->V(Landroid/net/Uri;Landroid/content/Context;)Ljava/io/File;
    ...
    .line 20
    .line 21
    invoke-direct {v1, p0}, Lbcxr;-><init>(Landroid/content/Context;)V
...
.method public static b(Landroid/content/Context;Landroid/net/Uri;Landroid/net/Uri;)V
    ...
    .line 1
    :try_start_0
    invoke-static {p2, p0}, Lbaxx;->V(Landroid/net/Uri;Landroid/content/Context;)Ljava/io/File;
    ...
    :try_end_0
    .catch Lbcye; {:try_start_0 .. :try_end_0} :catch_0
    .catch Landroid/system/ErrnoException; {:try_start_0 .. :try_end_0} :catch_0
