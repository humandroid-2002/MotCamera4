...
.field public final eventDispatcher:Lkotlin/DeepRecursiveFunction;
...
.method public static constructor <clinit>()V
    ...
    sput-object v3, Landroidx/media3/exoplayer/upstream/DefaultBandwidthMeter;->DEFAULT_INITIAL_BITRATE_ESTIMATES_2G:Lcom/google/common/collect/RegularImmutableList;
    ...
    sput-object v3, Landroidx/media3/exoplayer/upstream/DefaultBandwidthMeter;->DEFAULT_INITIAL_BITRATE_ESTIMATES_3G:Lcom/google/common/collect/RegularImmutableList;
    ...
    sput-object v3, Landroidx/media3/exoplayer/upstream/DefaultBandwidthMeter;->DEFAULT_INITIAL_BITRATE_ESTIMATES_4G:Lcom/google/common/collect/RegularImmutableList;
...
.method public constructor <init>(Landroid/content/Context;Ljava/util/HashMap;ILandroidx/media3/common/util/SystemClock;Z)V
    ...
    new-instance p2, Lkotlin/DeepRecursiveFunction;

    const/4 v0, 0x7

    invoke-direct {p2, v0}, Lkotlin/DeepRecursiveFunction;-><init>(I)V

    iput-object p2, p0, Landroidx/media3/exoplayer/upstream/DefaultBandwidthMeter;->eventDispatcher:Lkotlin/DeepRecursiveFunction;
    ...
    iget-object p2, p1, Landroidx/media3/common/util/NetworkTypeObserver;->networkTypeLock:Ljava/lang/Object;

    monitor-enter p2

    :try_start_0
    iget p3, p1, Landroidx/media3/common/util/NetworkTypeObserver;->networkType:I
    ...
    invoke-virtual {p0, p3}, Landroidx/media3/exoplayer/upstream/DefaultBandwidthMeter;->getInitialBitrateEstimateForNetworkType(I)J
    ...
    iget-object p0, p1, Landroidx/media3/common/util/NetworkTypeObserver;->listeners:Ljava/lang/Object;
    ...
    iget-object p0, p1, Landroidx/media3/common/util/NetworkTypeObserver;->mainHandler:Ljava/lang/Object;

    check-cast p0, Landroid/os/Handler;

    new-instance p3, Lcom/motorola/camera/Controller$$ExternalSyntheticLambda3;

    const/4 p4, 0x3

    invoke-direct {p3, p4, p1, p2}, Lcom/motorola/camera/Controller$$ExternalSyntheticLambda3;-><init>(ILjava/lang/Object;Ljava/lang/Object;)V
...
.method public final maybeNotifyBandwidthSample(JJI)V
    .locals 9
    ...
    :cond_0
    iput-wide p3, p0, Landroidx/media3/exoplayer/upstream/DefaultBandwidthMeter;->lastReportedBitrateEstimate:J

    iget-object p0, p0, Landroidx/media3/exoplayer/upstream/DefaultBandwidthMeter;->eventDispatcher:Lkotlin/DeepRecursiveFunction;
    ...
    iget-boolean v1, v0, Landroidx/media3/exoplayer/upstream/BandwidthMeter$EventListener$EventDispatcher$HandlerAndListener;->released:Z
    ...
    iget-object v0, v0, Landroidx/media3/exoplayer/upstream/BandwidthMeter$EventListener$EventDispatcher$HandlerAndListener;->handler:Landroid/os/Handler;
