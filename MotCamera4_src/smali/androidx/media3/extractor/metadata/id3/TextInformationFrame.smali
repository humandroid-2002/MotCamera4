...
.method public final populateMediaMetadata(Landroidx/media3/common/MediaMetadata$Builder;)V
    ...
    invoke-virtual {p1, v0}, Landroidx/media3/common/MediaMetadata$Builder;->setReleaseDay(Ljava/lang/Integer;)V
    ...
    invoke-virtual {p1, v0}, Landroidx/media3/common/MediaMetadata$Builder;->setReleaseMonth(Ljava/lang/Integer;)V
    ...
    invoke-virtual {p1, p0}, Landroidx/media3/common/MediaMetadata$Builder;->setReleaseYear(Ljava/lang/Integer;)V
    ...
    invoke-virtual {p1, v0}, Landroidx/media3/common/MediaMetadata$Builder;->setRecordingDay(Ljava/lang/Integer;)V
    ...
    invoke-virtual {p1, v0}, Landroidx/media3/common/MediaMetadata$Builder;->setRecordingMonth(Ljava/lang/Integer;)V
    ...
    invoke-virtual {p1, p0}, Landroidx/media3/common/MediaMetadata$Builder;->setRecordingYear(Ljava/lang/Integer;)V
    ...
    invoke-virtual {p1, p0}, Landroidx/media3/common/MediaMetadata$Builder;->setWriter(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {p1, p0}, Landroidx/media3/common/MediaMetadata$Builder;->setTitle(Ljava/lang/CharSequence;)V
    ...
    invoke-static {p0}, Landroidx/media3/common/util/Util;->split(Ljava/lang/String;)[Ljava/lang/String;
    ...
    invoke-virtual {p1, v0}, Landroidx/media3/common/MediaMetadata$Builder;->setTrackNumber(Ljava/lang/Integer;)V

    invoke-virtual {p1, p0}, Landroidx/media3/common/MediaMetadata$Builder;->setTotalTrackCount(Ljava/lang/Integer;)V
    :try_end_1
    ...
    invoke-virtual {p1, p0}, Landroidx/media3/common/MediaMetadata$Builder;->setConductor(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {p1, p0}, Landroidx/media3/common/MediaMetadata$Builder;->setAlbumArtist(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {p1, p0}, Landroidx/media3/common/MediaMetadata$Builder;->setArtist(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {p1, p0}, Landroidx/media3/common/MediaMetadata$Builder;->setRecordingDay(Ljava/lang/Integer;)V
    :try_end_2
    ...
    invoke-virtual {p1, p0}, Landroidx/media3/common/MediaMetadata$Builder;->setComposer(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {p1, p0}, Landroidx/media3/common/MediaMetadata$Builder;->setAlbumTitle(Ljava/lang/CharSequence;)V
