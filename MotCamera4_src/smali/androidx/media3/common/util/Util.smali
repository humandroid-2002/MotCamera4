...
.method public static binarySearchFloor(Lcom/adobe/xmp/impl/ParseState;J)I
    .locals 7
    ...
    .line 2
    invoke-virtual {p0, v4}, Lcom/adobe/xmp/impl/ParseState;->get(I)J
    ...
    .line 3
    iget v4, p0, Lcom/adobe/xmp/impl/ParseState;->pos:I

    if-ge v3, v4, :cond_2

    .line 4
    invoke-virtual {p0, v3}, Lcom/adobe/xmp/impl/ParseState;->get(I)J
...
.method public static binarySearchFloor(Ljava/util/List;Ljava/lang/Long;Z)I
    .locals 2
...
.method public static handlePlayButtonAction(Landroidx/media3/common/Player;)Z
    ...
    invoke-virtual {v1, v3, v0}, Landroidx/media3/common/BasePlayer;->seekToDefaultPositionInternal(II)V
    ...
    invoke-virtual {p0, v2}, Landroidx/media3/exoplayer/ExoPlayerImpl;->setPlayWhenReady(Z)V
...
.method public static inferContentTypeForUriAndMimeType(Landroid/net/Uri;Ljava/lang/String;)I
    ...
    invoke-static {p1}, Lkotlin/ResultKt;->toLowerCase(Ljava/lang/String;)Ljava/lang/String;
