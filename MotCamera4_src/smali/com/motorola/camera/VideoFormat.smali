...
.method public static constructor <clinit>()V
    ...
    invoke-direct {v14, v11, v3}, Landroid/util/Size;-><init>(II)V

    sput-object v14, Lcom/motorola/camera/VideoFormat;->FHD_18V9:Landroid/util/Size;
    ...
    sput-object v14, Lcom/motorola/camera/VideoFormat;->FHD_19P5V9:Landroid/util/Size;
    ...
    sput-object v15, Lcom/motorola/camera/VideoFormat;->FHD_20V9:Landroid/util/Size;
    ...
    sput-object v12, Lcom/motorola/camera/VideoFormat;->FHD_20P5V9:Landroid/util/Size;
    ...
    sput-object v0, Lcom/motorola/camera/VideoFormat;->FHD_21V9:Landroid/util/Size;
    ...
    sput-object v10, Lcom/motorola/camera/VideoFormat;->FHD_22V9:Landroid/util/Size;
    ...
    sput-object v9, Lcom/motorola/camera/VideoFormat;->CLI_FHD:Landroid/util/Size;
    ...
    sput-object v9, Lcom/motorola/camera/VideoFormat;->EQU_FHD:Landroid/util/Size;
    ...
    sput-object v8, Lcom/motorola/camera/VideoFormat;->EQU_4K:Landroid/util/Size;
    ...
    sput-object v7, Lcom/motorola/camera/VideoFormat;->UHD_4K:Landroid/util/Size;

    new-instance v11, Landroid/util/Size;

    invoke-direct {v11, v1, v1}, Landroid/util/Size;-><init>(II)V

    sput-object v11, Lcom/motorola/camera/VideoFormat;->UHD_4K_SQUARE:Landroid/util/Size;
    ...
    sput-object v1, Lcom/motorola/camera/VideoFormat;->UHD_4K_19V9:Landroid/util/Size;
    ...
    invoke-direct {v6, v4, v9}, Landroid/util/Size;-><init>(II)V

    sput-object v6, Lcom/motorola/camera/VideoFormat;->UHD_4K_19P5V9:Landroid/util/Size;
    ...
    invoke-direct {v9, v4, v10}, Landroid/util/Size;-><init>(II)V

    sput-object v9, Lcom/motorola/camera/VideoFormat;->UHD_4K_20V9:Landroid/util/Size;
    ...
    invoke-direct {v10, v4, v2}, Landroid/util/Size;-><init>(II)V

    sput-object v10, Lcom/motorola/camera/VideoFormat;->UHD_4K_20V9_2:Landroid/util/Size;
    ...
    invoke-direct {v4, v0, v12}, Landroid/util/Size;-><init>(II)V
    ...
    invoke-direct {v12, v0, v15}, Landroid/util/Size;-><init>(II)V

    sput-object v12, Lcom/motorola/camera/VideoFormat;->UHD_4K_21V9_2:Landroid/util/Size;
    ...
    invoke-direct {v15, v0, v14}, Landroid/util/Size;-><init>(II)V

    sput-object v15, Lcom/motorola/camera/VideoFormat;->UHD_4K_21V9_3:Landroid/util/Size;
    ...
    invoke-direct {v14, v0, v3}, Landroid/util/Size;-><init>(II)V

    sput-object v14, Lcom/motorola/camera/VideoFormat;->UHD_4K_22V9:Landroid/util/Size;
    ...
    invoke-direct {v3, v0, v13}, Landroid/util/Size;-><init>(II)V

    sput-object v3, Lcom/motorola/camera/VideoFormat;->UHD_4K_22V9_2:Landroid/util/Size;
    ...
    invoke-direct {v5, v13, v2}, Landroid/util/Size;-><init>(II)V

    sput-object v5, Lcom/motorola/camera/VideoFormat;->UHD_6K:Landroid/util/Size;
    ...
    sput-object v2, Lcom/motorola/camera/VideoFormat;->UHD_6K_39V18:Landroid/util/Size;
    ...
    invoke-direct {v10, v13, v9}, Landroid/util/Size;-><init>(II)V

    sput-object v10, Lcom/motorola/camera/VideoFormat;->UHD_6K_21V9:Landroid/util/Size;
    ...
    invoke-direct {v9, v13, v6}, Landroid/util/Size;-><init>(II)V

    sput-object v9, Lcom/motorola/camera/VideoFormat;->UHD_8K:Landroid/util/Size;
    ...
    invoke-direct {v6, v13, v1}, Landroid/util/Size;-><init>(II)V
    ...
    invoke-direct {v1, v13, v8}, Landroid/util/Size;-><init>(II)V

    sput-object v1, Lcom/motorola/camera/VideoFormat;->UHD_8K_20P5V9:Landroid/util/Size;
    ...
    invoke-direct {v8, v13, v13}, Landroid/util/Range;-><init>(Ljava/lang/Comparable;Ljava/lang/Comparable;)V

    sput-object v8, Lcom/motorola/camera/VideoFormat;->FPS_DEFAULT:Landroid/util/Range;

    const/4 v8, 0x3

    new-array v13, v8, [Landroid/util/Size;
    ...
    sput-object v1, Lcom/motorola/camera/VideoFormat;->UHD_8K_SIZES:Ljava/util/List;

    const/4 v13, 0x3

    new-array v6, v13, [Landroid/util/Size;
    ...
    sput-object v5, Lcom/motorola/camera/VideoFormat;->UHD_6K_SIZES:Ljava/util/List;

    invoke-static {v0}, Ljava/util/Collections;->singletonList(Ljava/lang/Object;)Ljava/util/List;

    move-result-object v0

    sput-object v0, Lcom/motorola/camera/VideoFormat;->UHD_5K_SIZES:Ljava/util/List;
    ...
    aput-object v39, v6, v10

    const/16 v11, 0x9

    aput-object v38, v6, v11
    ...
    aput-object v35, v6, v13

    invoke-static {v6}, Ljava/util/Arrays;->asList([Ljava/lang/Object;)Ljava/util/List;

    move-result-object v6

    sput-object v6, Lcom/motorola/camera/VideoFormat;->UHD_4K_SIZES:Ljava/util/List;
    ...
    sput-object v11, Lcom/motorola/camera/VideoFormat;->FHD_SIZES:Ljava/util/List;

    new-array v12, v3, [Landroid/util/Size;
    ...
    sput-object v12, Lcom/motorola/camera/VideoFormat;->HD_SIZES:Ljava/util/List;

    invoke-static/range {v18 .. v18}, Ljava/util/Collections;->singletonList(Ljava/lang/Object;)Ljava/util/List;

    move-result-object v13

    sput-object v13, Lcom/motorola/camera/VideoFormat;->QHD_SIZES:Ljava/util/List;

    invoke-static/range {v17 .. v17}, Ljava/util/Collections;->singletonList(Ljava/lang/Object;)Ljava/util/List;

    move-result-object v14

    sput-object v14, Lcom/motorola/camera/VideoFormat;->VGA_SIZES:Ljava/util/List;
    ...
    invoke-direct {v0, v8}, Lcom/motorola/camera/VideoFormat$$ExternalSyntheticLambda0;-><init>(I)V
